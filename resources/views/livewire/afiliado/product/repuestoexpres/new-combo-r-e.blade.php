<div>
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                        ...
                        @if($controlActivity)
                            <span>Editar Combo RepuestoExpres</span>
                        @else
                            <span>Crear Combo RepuestoExpres</span>
                        @endif
                    </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="/listCombos/{{$comercio->user_id}}">Combos</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                <form autocomplete="off" wire:submit.prevent="{{ $controlActivity ? 'updateCombo' : 'createCombo' }}">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="container_id">Contenedor<span class="text-danger">*</span></label>
                                                <div class="input-group mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="container_id">Contenedor de Productos<span class="text-danger">*</span></label>
                                                <div class="input-group mb-3">
                                                    <select wire:model.defer="state.pack_products_id"  id="pack_products_id" class="font-costo form-control @error('pack_products_id') is-invalid @enderror" autofocus >
                                                        <option value="0">Seleccione una opción</option>
                                                        @foreach($containers as $container)
                                                            <option value="{{$container->id}}">{{$container->name}}</option>
                                                        @endforeach

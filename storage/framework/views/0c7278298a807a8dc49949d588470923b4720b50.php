...
} elseif ($_instance->childHasBeenRendered('l3108815712-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3108815712-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3108815712-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3108815712-0');
} else {
    $response = \Livewire\Livewire::mount('components.currency');
    $html = $response->html();
    $_instance->logRenderedChild('l3108815712-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
            ...
            <div class="header-main fixed-top bg-red" style="width: 100vw !important;">
                <div class="header" style="width: 100vw !important;">
                    <div class="logo">
                        <a class="" href="/"><img class="logo-navbar" src="<?php echo e($comercio->avatar_url); ?>" alt=""></a>
                    </div>
                    <!-- The form -->
                    <div class="search">
...
} elseif ($_instance->childHasBeenRendered('l3108815712-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3108815712-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3108815712-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3108815712-1');
} else {
    $response = \Livewire\Livewire::mount('carrito.cart-drop');
    $html = $response->html();
    $_instance->logRenderedChild('l3108815712-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                        </div>
...
} elseif ($_instance->childHasBeenRendered('l3108815712-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3108815712-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3108815712-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3108815712-2');
} else {
    $response = \Livewire\Livewire::mount('components.menu-component',[
                                'comercioId' => 1,
                            ]);
    $html = $response->html();
    $_instance->logRenderedChild('l3108815712-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.currency')->html();
} elseif ($_instance->childHasBeenRendered('l3108815712-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3108815712-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3108815712-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3108815712-3');
} else {
    $response = \Livewire\Livewire::mount('components.currency');
    $html = $response->html();
    $_instance->logRenderedChild('l3108815712-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('carrito.cart-drop')->html();
} elseif ($_instance->childHasBeenRendered('l3108815712-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l3108815712-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3108815712-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3108815712-4');
} else {
    $response = \Livewire\Livewire::mount('carrito.cart-drop');
    $html = $response->html();
    $_instance->logRenderedChild('l3108815712-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php /**PATH /home/typej/Documentos/github/repuestoexpres/resources/views/livewire/layouts/navbar-nuevo.blade.php ENDPATH**/ ?>
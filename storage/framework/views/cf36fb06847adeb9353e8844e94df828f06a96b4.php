...
} elseif ($_instance->childHasBeenRendered('vdem6oq')) {
    $componentId = $_instance->getRenderedChildComponentId('vdem6oq');
    $componentTag = $_instance->getRenderedChildComponentTagName('vdem6oq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vdem6oq');
} else {
    $response = \Livewire\Livewire::mount('layouts.navbar-nuevo', [
                    'comercioId' => 1,
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('vdem6oq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('fZt9JjB')) {
    $componentId = $_instance->getRenderedChildComponentId('fZt9JjB');
    $componentTag = $_instance->getRenderedChildComponentTagName('fZt9JjB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fZt9JjB');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('fZt9JjB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('WCUoDOC')) {
    $componentId = $_instance->getRenderedChildComponentId('WCUoDOC');
    $componentTag = $_instance->getRenderedChildComponentTagName('WCUoDOC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WCUoDOC');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('WCUoDOC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH /home/typej/Documentos/github/repuestoexpres/resources/views/externalviews/view-details.blade.php ENDPATH**/ ?>
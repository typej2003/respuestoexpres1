...
} elseif ($_instance->childHasBeenRendered('l3668674179-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3668674179-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3668674179-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3668674179-0');
} else {
    $response = \Livewire\Livewire::mount('admin.profile.basic-data', ['user_id' => auth()->user()->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('l3668674179-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('l3668674179-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3668674179-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3668674179-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3668674179-1');
} else {
    $response = \Livewire\Livewire::mount('admin.profile.billing-details', ['user_id' => auth()->user()->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('l3668674179-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/typej/Documentos/github/repuestoexpres/resources/views/livewire/admin/profile/update-profile.blade.php ENDPATH**/ ?>
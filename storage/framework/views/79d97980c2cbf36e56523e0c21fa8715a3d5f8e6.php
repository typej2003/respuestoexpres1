...
} elseif ($_instance->childHasBeenRendered('l3283468006-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3283468006-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3283468006-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3283468006-0');
} else {
    $response = \Livewire\Livewire::mount('carrito.cart-drop', ['currencyValue' => $currencyValue ]);
    $html = $response->html();
    $_instance->logRenderedChild('l3283468006-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('l3283468006-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3283468006-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3283468006-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3283468006-1');
} else {
    $response = \Livewire\Livewire::mount('components.currency');
    $html = $response->html();
    $_instance->logRenderedChild('l3283468006-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/typej/Documentos/github/barcoexpres-1/resources/views/livewire/layouts/navbar-in.blade.php ENDPATH**/ ?>
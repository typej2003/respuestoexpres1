...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('S6qQtZc')) {
    $componentId = $_instance->getRenderedChildComponentId('S6qQtZc');
    $componentTag = $_instance->getRenderedChildComponentTagName('S6qQtZc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('S6qQtZc');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('S6qQtZc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('cart.cart1')->html();
} elseif ($_instance->childHasBeenRendered('yNitiU9')) {
    $componentId = $_instance->getRenderedChildComponentId('yNitiU9');
    $componentTag = $_instance->getRenderedChildComponentTagName('yNitiU9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yNitiU9');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('yNitiU9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('AwChRcn')) {
    $componentId = $_instance->getRenderedChildComponentId('AwChRcn');
    $componentTag = $_instance->getRenderedChildComponentTagName('AwChRcn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AwChRcn');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('AwChRcn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/typej/Documentos/github/barcoexpres/resources/views/cart/cart.blade.php ENDPATH**/ ?>
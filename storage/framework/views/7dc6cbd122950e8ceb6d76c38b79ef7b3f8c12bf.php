                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody wire:loading.class="text-muted">
                                    <?php $__empty_1 = true; $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <th scope="row"><?php echo e($clientes->firstItem() + $index); ?></th>
                                        <td>
                                            <img src="<?php echo e($cliente->avatar_url); ?>" style="width: 50px;" class="img img-circle mr-1" alt="">
                                            <?php echo e($cliente->user->name); ?>

                                        </td>
                                        <td><?php echo e($cliente->user->email); ?></td>
                                        <td><?php echo e($cliente->datosbasicos->cellphonecode); ?>-<?php echo e($cliente->datosbasicos->cellphone); ?></td>
                                        <td><?php echo e($cliente->user->created_at->toFormattedDate() ?? 'N/A'); ?></td>
                                        <td>

                                            <a href="" wire:click.prevent="edit(<?php echo e($cliente); ?>)">
                                                <i class="fa fa-edit mr-2"></i>
                                            </a>

                                            <a href="" wire:click.prevent="confirmUserRemoval(<?php echo e($cliente->id); ?>)">
...
unset($__errorArgs, $__bag); ?>" id="name" aria-describedby="nameHelp" placeholder="Usuario">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="state.names" class="form-control <?php $__errorArgs = ['names'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="names" aria-describedby="namesHelp" placeholder="Nombres">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="state.surnames" class="form-control <?php $__errorArgs = ['surnames'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="surnames" aria-describedby="namesHelp" placeholder="Apellidos">
...
unset($__errorArgs, $__bag); ?>" name="cellphone" id="cellphone" placeholder="Celular">
...
unset($__errorArgs, $__bag); ?>" id="email" aria-describedby="emailHelp" placeholder="Email">
...
<?php /**PATH /home/typej/Documentos/github/barcoexpres/resources/views/livewire/cliente/list-clientes-comercio.blade.php ENDPATH**/ ?>